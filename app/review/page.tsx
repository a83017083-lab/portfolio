...
export default async function Page(){const [content,chatbot]=await Promise.all([getContent(),getChatbotSettings()]);return <SiteChrome chatbot={chatbot} announcement={content.announcement} whatsappUrl={content.businessWhatsappUrl} searchEntries={searchEntries(content)}><main><PageIntro n="09" label="PROJECT FEEDBACK" title="Share your experience." description="For people who have actually worked with me. Nothing appears on the website automatically."/><section className="v2-section v2-container"><ReviewForm/></section></main></SiteChrome>}
