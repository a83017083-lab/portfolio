...
export function SiteChrome({ children, chatbot, announcement, footer, whatsappUrl, searchEntries }: { children: React.ReactNode; chatbot: ChatbotSettings; announcement?: string; footer?: {brandLine:string;bottomLine:string}; whatsappUrl?: string; searchEntries: SearchEntry[] }) {
  ...
  return <div id="top" className={dark ? "v2-shell v2-dark" : "v2-shell"}>
    ...
    <footer className="v2-footer"><div className="v2-container v2-footer-grid"><div><Link href="/" className="v2-footer-brand">ABHINAV<span>®</span></Link><p>{footer?.brandLine || "Websites and automations, built with intent."}</p></div><div><small>EXPLORE</small>{routes.map(([href, title]) => <Link href={href} key={href}>{title}</Link>)}</div><div><small>ELSEWHERE</small><a href="https://github.com/a83017083-lab" target="_blank" rel="noopener noreferrer">GitHub ↗</a><a href="https://linktr.ee/buildweth_abhinavk7852" target="_blank" rel="noopener noreferrer">Socials ↗</a><Link href="/privacy">Privacy</Link><Link href="/terms">Terms</Link><Link href="/wallet-policy">Build Credit policy</Link><Link href="/refund-policy">Refund policy</Link></div></div><div className="v2-container v2-footer-bottom"><span>© 2026 Build With Abhinav</span><span>{footer?.bottomLine || "Built to work, not just look good."}</span></div></footer>
