...
function BackupAdmin(){return <><h1>Private backup</h1><p className="page-sub">Download a JSON snapshot of site content, inquiries, subscribers, private coupons, pending reviews, client records without access-code hashes, and recent activity. Keep it private; it contains visitor information.</p><div className="admin-panel"><h2>Export</h2><a className="admin-btn" href="/api/admin/backup" download="portfolio-backup.json">Download backup JSON</a><p className="hint" style={{marginTop:15}}>Restore is deliberately unavailable: overwriting live inquiries could lose newer messages. Keep a copy offline.</p></div></>}
